...
{
    public partial class BatchMetricValue
    {
        internal static BatchMetricValue DeserializeBatchMetricValue(JsonElement element)
        {
            ...
            return new BatchMetricValue(timeStamp, Optional.ToNullable(average), Optional.ToNullable(minimum), Optional.ToNullable(maximum), Optional.ToNullable(total), Optional.ToNullable(count));
        }
    }
}
