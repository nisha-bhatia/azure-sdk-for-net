...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class BatchMetricValue
    {
        ...
        internal BatchMetricValue(DateTimeOffset timeStamp)
        {
            TimeStamp = timeStamp;
        }
        ...
        internal BatchMetricValue(DateTimeOffset timeStamp, double? average, double? minimum, double? maximum, double? total, double? count)
        {
            TimeStamp = timeStamp;
            Average = average;
            Minimum = minimum;
