...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class MetricResultsResponseValuesItem
    {
        ...
        internal MetricResultsResponseValuesItem(string starttime, string endtime, IEnumerable<BatchMetric> value)
        {
        ...
        /// <param name="value"> The value of the collection. </param>
        internal MetricResultsResponseValuesItem(string starttime, string endtime, TimeSpan? interval, string @namespace, string resourceregion, string resourceid, IReadOnlyList<BatchMetric> value)
        {
            Starttime = starttime;
            Endtime = endtime;
            Interval = interval;
        ...
        public IReadOnlyList<BatchMetric> Value { get; }
    }
}
