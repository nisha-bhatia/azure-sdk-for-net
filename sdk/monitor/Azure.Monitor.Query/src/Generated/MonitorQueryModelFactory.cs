...
namespace Azure.Monitor.Query.Models
{
    ...
    public static partial class MonitorQueryModelFactory
    {
        ...
        public static MetricResultsResponseValuesItem MetricResultsResponseValuesItem(string starttime = null, string endtime = null, TimeSpan? interval = null, string @namespace = null, string resourceregion = null, string resourceid = null, IEnumerable<BatchMetric> value = null)
        {
            value ??= new List<BatchMetric>();
        ...
        /// <returns> A new <see cref="Models.BatchMetric"/> instance for mocking. </returns>
        public static BatchMetric BatchMetric(string id = null, LocalizableStringAutoGenerated name = null, string displayDescription = null, string type = null, BatchMetricUnit unit = default, IEnumerable<BatchTimeSeriesElement> timeseries = null, string errorCode = null, string errorMessage = null)
        {
            timeseries ??= new List<BatchTimeSeriesElement>();

            return new BatchMetric(id, name, displayDescription, type, unit, timeseries?.ToList(), errorCode, errorMessage);
        }

        /// <summary> Initializes a new instance of LocalizableStringAutoGenerated. </summary>
        /// <param name="value"> The invariant value. </param>
        /// <param name="localizedValue"> The display name. </param>
        /// <returns> A new <see cref="Models.LocalizableStringAutoGenerated"/> instance for mocking. </returns>
        public static LocalizableStringAutoGenerated LocalizableStringAutoGenerated(string value = null, string localizedValue = null)
        {
            return new LocalizableStringAutoGenerated(value, localizedValue);
        }
        ...
        /// <returns> A new <see cref="Models.BatchTimeSeriesElement"/> instance for mocking. </returns>
        public static BatchTimeSeriesElement BatchTimeSeriesElement(IEnumerable<BatchMetadataValue> metadatavalues = null, IEnumerable<BatchMetricValue> data = null)
        {
            metadatavalues ??= new List<BatchMetadataValue>();
            data ??= new List<BatchMetricValue>();

            return new BatchTimeSeriesElement(metadatavalues?.ToList(), data?.ToList());
        }

        /// <summary> Initializes a new instance of BatchMetadataValue. </summary>
        /// <param name="name"> The name of the metadata. </param>
        /// <param name="value"> The value of the metadata. </param>
        /// <returns> A new <see cref="Models.BatchMetadataValue"/> instance for mocking. </returns>
        public static BatchMetadataValue BatchMetadataValue(LocalizableStringAutoGenerated name = null, string value = null)
        {
            return new BatchMetadataValue(name, value);
        }

        /// <summary> Initializes a new instance of BatchMetricValue. </summary>
        ...
        /// <returns> A new <see cref="Models.BatchMetricValue"/> instance for mocking. </returns>
        public static BatchMetricValue BatchMetricValue(DateTimeOffset timeStamp = default, double? average = null, double? minimum = null, double? maximum = null, double? total = null, double? count = null)
        {
            return new BatchMetricValue(timeStamp, average, minimum, maximum, total, count);
        }
    }
}
