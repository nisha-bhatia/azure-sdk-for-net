...
namespace Azure.Monitor.Query
{
    internal partial class MetricsRestClient
    {
        ...
        /// <param name="batchEndpoint"> The regional endpoint to use, for example https://eastus.metrics.monitor.azure.com. The region should match the region of the requested resources. For global resources, the region should be 'global'. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="clientDiagnostics"/>, <paramref name="pipeline"/> or <paramref name="batchEndpoint"/> is null. </exception>
        public MetricsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string batchEndpoint, Uri endpoint = null)
        {
            ClientDiagnostics = clientDiagnostics ?? throw new ArgumentNullException(nameof(clientDiagnostics));
            _pipeline = pipeline ?? throw new ArgumentNullException(nameof(pipeline));
            _batchEndpoint = batchEndpoint ?? throw new ArgumentNullException(nameof(batchEndpoint));
        ...
        internal HttpMessage CreateBatchRequest(string subscriptionId, string metricnamespace, IEnumerable<string> metricnames, ResourceIdList resourceIds, string starttime, string endtime, TimeSpan? interval, string aggregation, int? top, string orderby, string filter)
        {
            ...
            var uri = new RawRequestUriBuilder();
            uri.AppendRaw(_batchEndpoint, false);
