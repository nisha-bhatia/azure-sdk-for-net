...
namespace Azure.Monitor.Query.Models
{
    ...
    public partial class MetricResultsResponseValuesItem
    {
        ...
        internal MetricResultsResponseValuesItem(string starttime, string endtime, IEnumerable<MetricResult> value)
        {
        ...
        /// <param name="value"> The value of the collection. </param>
        internal MetricResultsResponseValuesItem(string starttime, string endtime, TimeSpan? interval, string @namespace, string resourceregion, string resourceid, IReadOnlyList<MetricResult> value)
        {
            Starttime = starttime;
            Endtime = endtime;
            Interval = interval;
